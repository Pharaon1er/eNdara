<?php
   ...
   klassroom_initialise_colourswitcher($PAGE);
      ...
      $html = theme_klassroom_get_html_for_settings($OUTPUT, $PAGE);
   ...
   if (!empty($PAGE->theme->settings->contactno)) {
        $contactno = theme_klassroom_get_setting('contactno',true);
      }else {
        $contactno = '';
      }
   ...
   if (!empty($PAGE->theme->settings->footersection4heading)) {
      ...
      if (!empty($PAGE->theme->settings->footersection4link5url)) {
      	...
      	if (!empty($PAGE->theme->settings->backtotop)) {
      	          $PAGE->requires->js('/theme/klassroom/yui/bttotop.js');
      	}
...
<html <?php echo $OUTPUT->htmlattributes(); ?>>
   <head>
      ...
      <style>
         ...
         src: url('<?php echo $CFG->wwwroot ?>/theme/klassroom/fonts/opensans-regular-webfont.eot');
         src: url('<?php echo $CFG->wwwroot ?>/theme/klassroom/fonts/opensans-regular-webfont.eot?#iefix') format('embedded-opentype'), url('<?php echo $CFG->wwwroot ?>/theme/klassroom/fonts/opensans-regular-webfont.woff') format('woff'), url('<?php echo $CFG->wwwroot ?>/theme/klassroom/fonts/opensans-regular-webfont.ttf') format('truetype'), url('<?php echo $CFG->wwwroot ?>/theme/klassroom/fonts/opensans-regular-webfont.svg#open_sansregular') format('svg');
         font-weight: normal;
         font-style: normal;
         }
         @font-face {
         font-family: 'FontAwesome';
         src: url('<?php echo $CFG->wwwroot ?>/theme/klassroom/fonts/fontawesome-webfont.eot?v=4.7.0');
         src: url('<?php echo $CFG->wwwroot ?>/theme/klassroom/fonts/fontawesome-webfont.eot?#iefix&v=4.7.0') format('embedded-opentype'), url('<?php echo $CFG->wwwroot ?>/theme/klassroom/fonts/fontawesome-webfont.woff2?v=4.7.0') format('woff2'), url('<?php echo $CFG->wwwroot ?>/theme/klassroom/fonts/fontawesome-webfont.woff?v=4.7.0') format('woff'), url('<?php echo $CFG->wwwroot ?>/theme/klassroom/fonts/fontawesome-webfont.ttf?v=4.7.0') format('truetype'), url('<?php echo $CFG->wwwroot ?>/theme/klassroom/fonts/fontawesome-webfont.svg?v=4.7.0#fontawesomeregular') format('svg');
         font-weight: normal;
         font-style: normal;
         }
         @font-face {
         font-family: 'montserratregular';
         src: url('<?php echo $CFG->wwwroot ?>/theme/klassroom/fonts/montserrat-regular-webfont.eot');
         src: url('<?php echo $CFG->wwwroot ?>/theme/klassroom/fonts/montserrat-regular-webfont.eot?#iefix') format('embedded-opentype'),
         url('<?php echo $CFG->wwwroot ?>/theme/klassroom/fonts/montserrat-regular-webfont.woff') format('woff'),
         url('<?php echo $CFG->wwwroot ?>/theme/klassroom/fonts/montserrat-regular-webfont.ttf') format('truetype'),
         url('<?php echo $CFG->wwwroot ?>/theme/klassroom/fonts/montserrat-regular-webfont.svg#montserratregular') format('svg');
         font-weight: normal;
         font-style: normal;
         }  
      </style>
