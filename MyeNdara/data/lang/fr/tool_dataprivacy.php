...
/**
 * Strings for component 'tool_dataprivacy', language 'fr', branch 'MOODLE_35_STABLE'
 *
...
$string['showdataretentionsummary_desc'] = 'Si ce réglage est activé, un lien vers le résumé de conservation des données est affiché dans le pied de page et dans la page du profil utilisateur.';
