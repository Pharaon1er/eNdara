...
/**
 * Strings for component 'theme_adaptable', language 'fr', branch 'MOODLE_35_STABLE'
 *
...
$string['breadcrumbdesc'] = 'Configurez la couleur d\'arrière-plan du fil d\'ariane.';
...
<h2>Credits</h2>
<h3>About</h3>
<p>Adaptable est un thème responsive en 2 colonnes très paramètrable et basé sur le thème populaire BCU.i</p>
...
<br>
<p>Visitez le site Web d\'Adaptable pour plus d\'informations, conseils et astuces et assistance technique : <a href="https://adaptable.ws" target="_blank">adaptable.ws</a></p>
<br>
<h3>Signalement de Bugs</h3>
<p>Vous pouvez signaler des bugs (et s\'il vous plait, <b>SEULEMENT</b> bugs) dans notre <a href="https://bitbucket.org/covuni/moodle-theme_adaptable/issues" target="_blank">dépôt Bitbucket</a></p>
<br>
<h3>Support Technique</h3>
<p>Vous pouvez demander un support technique sur le site Web d\'Adaptable (seulement en anglais) <a href="https://adaptable.ws/support/support-tickets" target="_blank">Obtenir un support technique</a></p>
<br>
<p>ou vous pouvez poser vos questions sur le forum Moodle :</p>
<ul>
...
$string['edittopmargin'] = 'Configurez la marge haute des boutons d\'édition';
...
$string['enablemessagemenu'] = 'Menu Message';
$string['enablemessagemenudesc'] = 'Activez le menu Message dans l\'en-tête (par exemple, si la messagerie est globalement désactivée)';
...
$string['filteradminmessages'] = 'Filtre des messages Admin';
$string['filteradminmessagesdesc'] = 'Activer pour supprimer les messages de l\'utilisateur admin, cela peut réduire les messages système apparaissant pour les étudiants';
...
$string['headerbkcolor2desc'] = 'Ce champ permet de définir la couleur de fond de l\'en-tête inférieur.';
...
$string['headernavbarstylingheading'] = 'Style de barre de navigation';
$string['headernavbarstylingheadingdesc'] = 'Options de style pour le menu de navigation principal.';
...
$string['helptitle2'] = 'Deuxième lien d\'aide';
...
$string['mobilemenufontcolor'] = 'Couleur des polices du menu mobile';
$string['mobilemenufontcolordesc'] = 'Ce champ permet de définir la couleur de la police du menu principal sur les appareils mobiles (réduit)';
...
$string['notsubmitted'] = 'nons soumis';
...
$string['settingsmenucolors'] = 'Couleurs des menus';
$string['settingsmessagescolors'] = 'Couleurs des messages pop-up';
$string['settingsmobilemenucolors'] = 'Couleurs des menus Mobile';
...
$string['tickertext1'] = 'Texte du lecteur de nouvelles';
$string['tickertext1desc'] = 'Ajoutez le texte du lecteur de nouvelles en format liste. Voir le fichier Readme pour plus d\'informations.';
$string['tickertext2'] = 'Texte 2 du lecteur de nouvelles';
$string['tickertext2desc'] = 'En contrôlant l\'accès sur les champs de profil, vous pouvez montrer différents éléments de lecteur de nouvelles aux différents types d\'utilisateurs en utilisant ce deuxième champ de texte';
...
$string['viewselect'] = 'Affichage plein écran par défaut.';
$string['viewselectdesc'] = 'Mettre l\'affichage du site en plein écran en par défaut (lorsque l\'option de zoom est utilisée).';
