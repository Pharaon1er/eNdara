...
/**
 * Strings for component 'admin', language 'fr', branch 'MOODLE_35_STABLE'
 *
 * @package   admin
...
$string['configcourseoverviewfileslimit'] = 'Le nombre maximal de fichiers pouvant être ajoutés à un résumé de cours.';
