...
/**
 * Strings for component 'media_videojs', language 'fr', branch 'MOODLE_35_STABLE'
 *
...
$string['configaudioextensions'] = 'Une liste d\'extensions de fichiers audio supportés, séparées par des virgules. VideoJS essaiera d\'utiliser le lecteur audio natif du navigateur, si possible, et utilisera pour d\'autres formats le lecteur Flash, s\'il est supporté par le navigateur et si l\'utilisation de Flash en dernier recours est activée ci-dessous.';
