...
/**
 * Strings for component 'qtype_pmatch', language 'fr', branch 'MOODLE_35_STABLE'
 *
...
$string['env_dictmissing2'] = 'L\'étudiant a tenté une vérification orthographique dans la langue « {$a} ». Mais le dictionnaire aspell pour cette langue n\'est pas installé.';
...
$string['ie_lastsubcontenttypeworddelimiter'] = 'Le caractère de délimitation du mot ne doit pas se terminer par un sous-contenu « {$a} ».';
...
$string['spellingmistakes'] = 'Les mots suivants ne sont pas dans notre dictionnaire : {$a}. Veuillez corriger votre orthographe.';
$string['synonym'] = 'Synonymes';
$string['synonymcontainsillegalcharacters'] = 'Le synonyme contient des caractères non valides.';
$string['synonymsheader'] = 'Définir les synonymes pour les mots dans les réponses';
$string['synonymsno'] = 'Synonymes {$a}';
$string['testquestionformheader'] = 'Réponses cochées à télécharger';
$string['testquestionuploadanother'] = 'Télécharger un autre fichier';
$string['testthisquestion'] = 'Tester cette question';
$string['toomanywords'] = 'Votre réponse est trop longue. Veuillez la modifier afin qu’elle ne soit pas supérieure à 20 mots.';
$string['unparseable'] = 'Nous ne comprenons pas les caractères ou la ponctuation ici « {$a} »';
$string['wordcontainsillegalcharacters'] = 'Le mot contient des caractères non valides.';
